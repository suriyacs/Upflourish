        ...
        new webpack.DefinePlugin({
          IS_DEV: IS_DEV,
					'process.env': {
                        ...
                        LINKED_IN_CLIENT_ID: JSON.stringify(process.env.LINKED_IN_CLIENT_ID),
                        TENANT_NAME: JSON.stringify(process.env.TENANT_NAME),
                        DISQUS_URL: JSON.stringify(process.env.DISQUS_URL),
                        SECRET_KEY: JSON.stringify(process.env.SECRET_KEY),
                        PUB_KEY: JSON.stringify(process.env.PUB_KEY),
                        DEV_HOST: JSON.stringify(process.env.DEV_HOST),
                        DEV_PROTOCOL: JSON.stringify(process.env.DEV_PROTOCOL)
					}
        }),
